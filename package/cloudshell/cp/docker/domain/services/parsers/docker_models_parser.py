...
from cloudshell.cp.docker.models.docker_cloud_provider_resource_model import DockerCloudProviderResourceModel


class DockerModelsParser(object):
    @staticmethod
    ...
    def convert_to_docker_resource_model(resource):
        ...
        docker_resource_model = DockerCloudProviderResourceModel()
    ...
    def convert_to_deployment_resource_model(deployment_request):
        ...
        deployment_resource_model.docker_image_command = data_holder.docker_params.docker_image_command
